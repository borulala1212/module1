...
def main():
	...
	if choice == "AICare":
		img = Image.open("COVERUTAMA2.png")
			...
			if result:
				...
				if option == "Disease Prediction":
					...
					if choice1 == "Breast Cancer Disease":
						BC = ["Explore Data","Breast Cancer Prediction"]
						...
						DD = ["Explore Data","Diabetes Prediction"]
					...
					## LIVER DISEASE
						...
						DD = ["Explore Data","Liver Prediction"]
